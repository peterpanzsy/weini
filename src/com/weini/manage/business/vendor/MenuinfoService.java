...
import com.weini.manage.dao.vendor.MenuDao;
...
public class MenuinfoService extends GeneralService {
	...
	public List<TMenuinfo> listMenuInfo(boolean isExistGood,int vendorId){
		List<TMenuinfo> res;
		res = menuDao.listMenuInfo(isExistGood,vendorId);
		this.close();
		return res;
	}
