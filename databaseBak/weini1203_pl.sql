...
drop database if exists weini;
create database weini default character set utf8;
use weini;

#create a USER and grant him for the database:
grant all privileges on weini.* to 'admin'@'%' identified by 'admin';
