...
$(document).ready( function() {
    $('<audio id="chatAudio"><source src="vendor/sound/notify.ogg" type="audio/ogg"><source src="vendor/sound/notify.mp3" type="audio/mpeg"><source src="vendor/sound/notify.wav" type="audio/wav"></audio>').appendTo('body');
...
//		$(".open").removeClass("open");
    ...
    //订单管理
    switch($pathname){
        case "/weini/vendor/pages/orderManage/manageOrder.jsp":
            $("#manageOrderLi").css("background-color","#FFF");
            break;
        case "/weini/vendor/pages/orderManage/historyOrder.jsp":
            $("#historyOrderLi").css("background-color","#FFF");
            break;
    }
	//用户管理
	switch($pathname){
	case "/weini/vendor/pages/adminManage/rootAdmin.jsp":
		$("#rootAdminLi").css("background-color","#FFF");
		break;
	case "/weini/vendor/pages/adminManage/financeAdmin.jsp":
		$("#financeAdminLi").css("background-color","#FFF");
		break;
	case "/weini/vendor/pages/adminManage/goodAdmin.jsp":
		$("#goodAdminLi").css("background-color","#FFF");
		break;
	case "/weini/vendor/pages/adminManage/ordinaryAdmin.jsp":
		$("#ordinaryAdminLi").css("background-color","#FFF");
		break;
	case "/weini/vendor/pages/vendorManage/manageVendor.jsp":
		$("#manageVendorLi").css("background-color","#FFF");
		break;
	}	
	//商品管理
	switch($pathname){
	case "/weini/vendor/pages/goodManage/existGood.jsp":
		$("#existGoodli").css("background-color","#FFF");
		break;
	case "/weini/vendor/pages/goodManage/deletedGood.jsp":
		$("#deletedGoodli").css("background-color","#FFF");
		break;
	case "/weinivendor/pages/goodManage/addGood.jsp":
		$("#addGoodli").css("background-color","#FFF");
		break;
	}
	//报表统计
	switch($pathname){
	case "/weini-vendor/pages/reportManage/statistics.jsp":
		$("#statistics").css("background-color","#FFF");
		break;
	case "/weini-vendor/pages/reportManage/userPrefer.jsp":
