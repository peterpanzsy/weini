    ...
    <div class="template-page-wrapper">
      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
          <ol class="breadcrumb">
            <li><a href="vendor/pages/index.jsp">返回首页</a></li>
            <li><a href="vendor/pages/orderManage/historyOrder.jsp">订单管理</a></li>
            <li class="active">历史订单</li>
              <input id="dateFlag" value="history" style="display: none"/>
          </ol>
...
<input id="role" value="root" style="display:none" />
    ...
    <script type="text/javascript" charset="utf8" src="vendor/js/orderManage.js"></script>
</body>
</html>