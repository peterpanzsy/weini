      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
          <ol class="breadcrumb">
            ...
            <li><a href="vendor/pages/goodManage/deletedGood.jsp">商品管理</a></li>
            <li class="active">暂不供应菜单</li>
          </ol>
          <div><h1>菜单列表</h1></div>
...
<input id="role" value="root" style="display:none" />
    ...
    <script type="text/javascript" charset="utf8" src="vendor/js/existOrDeletedGood.js"></script>
</body>
</html>